...
app.get('/api/',(req,res)=>{
    const obj = [{name:"shahid",college:"upes"}];
    res.send(obj);
...
// /g → global flag, so it finds all matches in the string, not just the first one.


app.get('/replace', (req, res) => {
    const text = "aaabcaaa";  // directly define it here
